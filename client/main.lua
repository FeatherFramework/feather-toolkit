...
exports('CreatePed',
    function(spec)
        local o = Owner(); return o and ToolkitEntities.CreatePed(o, spec) or
        ToolkitResults.Err('unauthenticated', 'Calling resource is required.')
    end)
exports('RemoveEntity',
    function(id)
        local o = Owner(); return o and ToolkitEntities.Remove(o, id) or
        ToolkitResults.Err('unauthenticated', 'Calling resource is required.')
    end)
exports('CreateBlip',
    function(spec)
        local o = Owner(); return o and ToolkitBlips.Create(o, spec) or
        ToolkitResults.Err('unauthenticated', 'Calling resource is required.')
    end)
exports('RemoveBlip',
    function(id)
        local o = Owner(); return o and ToolkitBlips.Remove(o, id) or
        ToolkitResults.Err('unauthenticated', 'Calling resource is required.')
    end)
exports('RegisterKeyListener',
    function(control, cb, mode)
        local o = Owner(); return o and ToolkitKeys.Register(o, control, cb, mode) or
        ToolkitResults.Err('unauthenticated', 'Calling resource is required.')
    end)
exports('RemoveKeyListener',
    function(id)
        local o = Owner(); return o and ToolkitKeys.Remove(o, id) or
        ToolkitResults.Err('unauthenticated', 'Calling resource is required.')
    end)
exports('ResolveControl', ToolkitControls.Resolve)
exports('CreatePrompt',
    function(spec)
        local o = Owner(); return o and ToolkitPrompts.Create(o, spec) or
        ToolkitResults.Err('unauthenticated', 'Calling resource is required.')
    end)
exports('IsPromptCompleted',
    function(id)
        local o = Owner(); return o and ToolkitPrompts.Completed(o, id) or
        ToolkitResults.Err('unauthenticated', 'Calling resource is required.')
    end)
exports('SetPromptEnabled',
    function(id, v)
        local o = Owner(); return o and ToolkitPrompts.SetEnabled(o, id, v) or
        ToolkitResults.Err('unauthenticated', 'Calling resource is required.')
    end)
exports('RemovePrompt',
    function(id)
        local o = Owner(); return o and ToolkitPrompts.Remove(o, id) or
        ToolkitResults.Err('unauthenticated', 'Calling resource is required.')
    end)
